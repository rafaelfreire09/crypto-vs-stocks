...
import { ALL_SYMBOLS_TIME_SERIES_MONTHLY } from '../data/monthly_prices';
...
//       `query?function=${TIME_SERIES_MONTHLY}&symbol=${symbol}&apikey=${process.env.ALPHA_ADVANTAGE_API_KEY}`
//     );
...
//   try {
//     const { data } = await Axios.get(
//       `query?function=${SYMBOL_SEARCH}&keywords=${keyword}&apikey=${process.env.ALPHA_ADVANTAGE_API_KEY}`
//     );
